...
Deliver a working mini-application that demonstrates an idea analysis flow: user answers a short form → backend generates heuristic insights → frontend displays results (radar chart + lean canvas) → simple mentor dashboard shows awareness delta. Focus on clear UI and demo-ready flow.
...
- Deterministic heuristic Insight Engine that outputs 6 scores (0–100) and a draft Lean Canvas JSON.
...
- Improve heuristic engine and add tests.
